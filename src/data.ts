...
// Seed Workers (Initial empty master list, populated dynamically via Enrollment or Firestore)
export const initialWorkers: Worker[] = [];

// Seed Teams (Initial empty master list, populated dynamically via Team Management)
export const initialTeams: Team[] = [];

// Seed Attendance Records (Populated dynamically via Biometric Scanner or Firestore)
export const initialAttendance: AttendanceRecord[] = [];

// Seed Performance Evaluations (Populated dynamically via Performance Management)
...
export const initialNotifications: SystemNotification[] = [
  { id: "NOT-001", type: "Late Worker", title: "Punctuality Alert", message: "Roster check-in recorded 15 minutes after shift start time.", timestamp: "2026-07-01 08:20:00", read: false },
  { id: "NOT-002", type: "Absent Worker", title: "Absenteeism Notification", message: "Unexcused roster absence flagged for automated HR review.", timestamp: "2026-07-01 09:00:00", read: false },
...
export const initialDamageReports: PanelDamageReport[] = [
  {
    ...
    reportedBy: "Site Formwork Carpenter",
