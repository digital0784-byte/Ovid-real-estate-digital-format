...
const SEED_NOTIFICATIONS: EnterpriseNotification[] = [
  ...
  // 2. Warehouse
  {
    ...
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.HEAD_OFFICE, UserRole.PROJECT_MANAGER, UserRole.WAREHOUSE_MANAGER, UserRole.STORE_OWNER],
    date: "2026-07-23",
    time: "06:45 AM",
  ...
  // 4. Material Request
  {
    ...
    receiver: "Project Manager & Warehouse",
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.WAREHOUSE_MANAGER],
    date: "2026-07-23",
    time: "08:10 AM",
  ...
  // 5. Material Approval
  {
    ...
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.HEAD_OFFICE, UserRole.FINANCE_MANAGER, UserRole.PROJECT_MANAGER],
    date: "2026-07-22",
    time: "11:20 AM",
  ...
  // 7. Material Return
  {
    ...
    sender: "Site Inspection Team",
    senderRole: "Site Engineer",
    receiver: "Store Owner & Formwork Team",
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.STORE_OWNER, UserRole.ASSEMBLER],
    date: "2026-07-23",
    time: "07:50 AM",
  ...
  // 9. Procurement
  {
    ...
    senderRole: "Head Office",
    receiver: "Head Office & Finance",
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.HEAD_OFFICE, UserRole.FINANCE_MANAGER],
    date: "2026-07-21",
    time: "03:40 PM",
  ...
  // 10. Purchase Order
  {
    ...
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.WAREHOUSE_MANAGER, UserRole.STORE_OWNER],
    date: "2026-07-22",
    time: "10:15 AM",
  ...
  // 11. Delivery
  {
    ...
    senderRole: "System AI",
    receiver: "Site Engineer & Inspector",
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.SITE_ENGINEER, UserRole.DRIVER],
    date: "2026-07-23",
    time: "08:12 AM",
  ...
  // 15. Project Progress
  {
    ...
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.HEAD_OFFICE, UserRole.PROJECT_MANAGER, UserRole.SITE_ENGINEER],
    date: "2026-07-22",
    time: "06:00 PM",
  ...
  // 17. QA/QC
  {
    ...
    senderRole: "Site Engineer",
    receiver: "Engineers & Inspectors",
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.SITE_ENGINEER],
    date: "2026-07-21",
    time: "11:00 AM",
  ...
  // 18. NCR
  {
    ...
    sender: "Quality Lead",
    senderRole: "Site Engineer",
    receiver: "Project Manager & Quality Lead",
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.SITE_ENGINEER],
    date: "2026-07-23",
    time: "07:30 AM",
  ...
  // 29. Document Approval
  {
    ...
    targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.SITE_ENGINEER, UserRole.SURVEYOR],
    date: "2026-07-21",
    time: "02:30 PM",
  ...
  // 31. System Update
  {
    ...
    targetRoles: [
      ...
      UserRole.STORE_OWNER, UserRole.PROJECT_MANAGER, UserRole.SECTION_HEAD,
      UserRole.SUPERVISOR, UserRole.SITE_ENGINEER, UserRole.SURVEYOR,
      UserRole.HSE_OFFICER, UserRole.TEAM_LEADER, UserRole.GANG_CHIEF, UserRole.TIME_KEEPER,
      UserRole.ASSEMBLER, UserRole.DRIVER, UserRole.AUDITOR
    ],
    date: "2026-07-22",
    time: "01:00 AM",
  ...
  public static triggerAiAlertGenerator(alertType: 
    ...
    const generators: Record<string, () => Omit<EnterpriseNotification, "id" | "date" | "time" | "timestamp">> = {
      lowStock: () => ({
        ...
        senderRole: "System AI",
        receiver: "Warehouse Manager & Store Owner",
        targetRoles: [UserRole.SUPER_ADMIN, UserRole.WAREHOUSE_MANAGER, UserRole.STORE_OWNER],
        isAiGenerated: true,
        aiConfidence: 0.98,
        deliveryChannels: { inApp: true, push: true, email: true, sms: true },
      ...
      delayedDelivery: () => ({
        ...
        senderRole: "System AI",
        receiver: "Warehouse & Site Logistics",
        targetRoles: [UserRole.SUPER_ADMIN, UserRole.WAREHOUSE_MANAGER, UserRole.DRIVER],
        isAiGenerated: true,
        aiConfidence: 0.91,
        deliveryChannels: { inApp: true, push: true, email: false, sms: true },
      ...
      materialShortage: () => ({
        ...
        senderRole: "System AI",
        receiver: "Store Owner & Project Manager",
        targetRoles: [UserRole.SUPER_ADMIN, UserRole.PROJECT_MANAGER, UserRole.STORE_OWNER],
        isAiGenerated: true,
        aiConfidence: 0.93,
        deliveryChannels: { inApp: true, push: true, email: false, sms: false },
        actionTab: "enterpriseErp"
